...
const Projects = () => {
  return (
    <div name="projects" className=' w-full h-screen  bg-black text-white'>
      ...
      <a href='https://hellochatbytarun.netlify.app/'> <div   className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
     <img className="w-50 mx-auto  border-2 hover:border-[#FF4900] duration-300" src={Capture} />
        ...
        <a href='https://greenify-13813.web.app/'> <div  className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
       <img className="w-50 mx-auto border-2 hover:border-[#FF4900] duration-300" src={ecco} />
        ...
        <a href='https://react-ecommerce-be808.web.app/'> <div  className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
           <img className="w-50 mx-auto border-2 hover:border-[#FF4900] duration-300 " src={shop} />
           <p className='py-4'> Shop here with api</p>
